...
import SpawnedAgentModel from './models/SpawnedAgentModel.js';
...
import spawnedAgentsRouter from './routes/spawnedAgents.js';
...
// Use routers
app.use('/api/spawned-agents', spawnedAgentsRouter);

// Add direct route for agent chat
...
For example: "Top yield farms on Injective: Astroport INJ-USDT pool (15-20% APY), Helix Finance (8-12% APY)".
