...
const BuilderPage = () => {
  ...
  return (
    <div className="relative h-screen bg-gray-50">
      <div className="fixed top-2 left-1/2 transform -translate-x-1/2 bg-white rounded-lg shadow-2xl p-4 z-[9999] border-2 border-blue-200 flex items-center gap-4">
        <button
